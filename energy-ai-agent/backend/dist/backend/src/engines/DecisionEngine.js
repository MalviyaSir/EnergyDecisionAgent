...
export class DecisionEngine {
    analyze(records, observationsResponse, reasoningResponse) {
        if (records.length < 2) {
...
function decideAcSetpoint(context) {
...
function decidePeakShift(context) {
...
function decideNightStandby(context) {
...
function decideBatterySolarCharge(context) {
...
function decideSolarScheduling(context) {
...
function decideGridDependency(context) {
...
function decideTariffWashingSchedule(context) {
...
function decideWaterHeaterRuntime(context) {
...
function decideRefrigeratorCheck(context) {
...
function decideLedLighting(context) {
...
function createDraft({ context, linkedReasoning, title, reason, expectedImpact, estimatedEnergySaved, difficulty, implementationTime, risk, currentSituation, recommendedAction, expectedImprovement, baseScore, }) {
...
function calculatePriorityScore(draft) {
...
function buildDecisionContext(records, observationsResponse, reasoningResponse) {
...
function findReasoning(context, terms) {
...
function findObservation(context, types) {
