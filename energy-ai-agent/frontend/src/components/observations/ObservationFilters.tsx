...
export type ObservationFilter = 'All' | AgentObservation['severity'];

type ObservationFiltersProps = {
  activeFilter: ObservationFilter;
  onFilterChange: (filter: ObservationFilter) => void;
  search: string;
  onSearchChange: (value: string) => void;
};

const filters: ObservationFilter[] = ['All', 'Critical', 'High', 'Medium', 'Low', 'Positive'];

export function ObservationFilters({ activeFilter, onFilterChange, search, onSearchChange }: ObservationFiltersProps) {
  return (
